...
PYTAURI_STANDALONE = getenv("PYTAURI_STANDALONE") != "0"
...
# or you can set it to `"nicegui_app/**/*.py"` to protect all Python files in the project.
INCLUDE_FILE_PATTERNS = ("nicegui_app/**/*.py",)
...
EXCLUDE_FILE_PATTERNS = (
    "nicegui_app/**/__main__.py",
    # Cython doesn't support `match` statement yet,
    # so we exclude this file for now,
    # see: <https://github.com/cython/cython/issues/4029>.
    "nicegui_app/_tray_menu.py",
)
